package com.tlm.storecollab.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "store_cop." + tableName) // 确保前缀合法
    ...
    public void createSpacePictureTable(Space space) {
        // 动态创建分表
        // 仅为旗舰版团队空间创建分表
        if (Objects.equals(space.getSpaceType(), SpaceTypeEnum.TEAM.getValue()) && Objects.equals(space.getSpaceLevel(), SpaceLevelEnum.FLAGSHIP.getValue())) {
